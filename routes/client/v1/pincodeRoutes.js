...
const pincodeController = require('../../../controller/client/v1/pincode');
const {
...
router.route('/client/api/v1/pincode/:id').get(auth(PLATFORM.CLIENT),checkRolePermission,pincodeController.getPincodeById);
