...
const stateController = require('../../../controller/client/v1/state');
const {
...
router.route('/client/api/v1/state/:id').get(auth(PLATFORM.CLIENT),checkRolePermission,stateController.getStateById);
