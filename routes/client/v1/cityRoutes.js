...
const cityController = require('../../../controller/client/v1/city');
const {
...
router.route('/client/api/v1/city/:id').get(auth(PLATFORM.CLIENT),checkRolePermission,cityController.getCityById);
