...
const walletController = require('../../../controller/client/v1/wallet');
const {
...
router.route('/client/api/v1/wallet/:id').get(auth(PLATFORM.CLIENT),checkRolePermission,walletController.getWalletById);
