...
const productController = require('../../../controller/device/v1/product');
const {
...
router.route('/device/api/v1/product/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,productController.getProductById);
