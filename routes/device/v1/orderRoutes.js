...
const orderController = require('../../../controller/device/v1/order');
const {
...
router.route('/device/api/v1/order/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,orderController.getOrderById);
