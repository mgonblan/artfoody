...
const cartController = require('../../../controller/device/v1/cart');
const {
...
router.route('/device/api/v1/cart/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,cartController.getCartById);
