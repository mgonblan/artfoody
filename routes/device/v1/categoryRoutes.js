...
const categoryController = require('../../../controller/device/v1/category');
const {
...
router.route('/device/api/v1/category/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,categoryController.getCategoryById);
