...
const stateController = require('../../../controller/device/v1/state');
const {
...
router.route('/device/api/v1/state/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,stateController.getStateById);
