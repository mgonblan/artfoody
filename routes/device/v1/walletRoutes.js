...
const walletController = require('../../../controller/device/v1/wallet');
const {
...
router.route('/device/api/v1/wallet/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,walletController.getWalletById);
