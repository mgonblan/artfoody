...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Zelma98',
      password: 'qqElaqTWFHtVhXd',
      email: 'Hiram_Sporer53@yahoo.com',
      name: 'Mr. Susie Huel',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 17,
      mobileNo: '(265) 050-1145',
      resetPasswordLink: {},
      loginRetryLimit: 391,
      loginReactiveTime: '2023-02-18T00:18:17.873Z',
      id: '62dae29addccb1507939b7a5'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Van_Padberg88',
        'password':'MPoMYnDN1ATGILV',
        'email':'Narciso.Hagenes9@gmail.com',
        'name':'Anna Lind',
        'shippingAddress':[{
          '_id':false,
          'pincode':'lavender',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Narciso.Hagenes9@gmail.com', });
