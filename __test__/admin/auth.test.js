...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Eleanora16',
      password: 'khrza85JYijwOUF',
      email: 'Kayli90@yahoo.com',
      name: 'Amanda Grady',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 992,
      mobileNo: '(006) 071-0655',
      resetPasswordLink: {},
      loginRetryLimit: 105,
      loginReactiveTime: '2023-03-24T17:38:42.785Z',
      id: '62dae29addccb1507939b6cd'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Jaclyn50',
        'password':'Y6Wso0v52mHp2Ot',
        'email':'Johnathan_Johnston@hotmail.com',
        'name':'Mr. Anne Hegmann',
        'shippingAddress':[{
          '_id':false,
          'pincode':'process',
          'address1':'Mouse',
          'address2':'supply-chains',
          'landmark':'cyan',
          'city':'Zimbabwe',
          'isDefault':true,
          'state':'red',
          'addressType':'human-resource',
          'fullName':'Account',
          'mobile':688,
          'addressNo':607
        }],
        'wishlist':[{
          '_id':false,
          'productId':'human-resource'
        }],
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(315) 913-5728',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Johnathan_Johnston@hotmail.com', });
